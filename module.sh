...
function moduler() {
	...
	case $mod in
		qcacld-3.0 | qca-wifi-host-cmn | fw-api | audio-kernel | camera-kernel | data-kernel | datarmnet | datarmnet-ext | dataipa | display-drivers | video-driver | dts)
		readcmd
